...
urlpatterns = [
    ...
    path('buzzer/create-custom/', views.create_buzzer_game, name='create_buzzer_game'),
    path('buzzer/update-custom/', views.update_buzzer_game, name='update_buzzer_game'),
    path('buzzer/<str:room_code>/monitor/', views.buzzer_monitor, name='buzzer_monitor'),
    path('buzzer/<str:room_code>/end/', views.end_buzzer_game_by_room_code, name='end_buzzer_game_by_room_code'),
    path('host-points/create-custom/', views.create_host_points_game, name='create_host_points_game'),
    path('host-points/update-custom/', views.update_host_points_game, name='update_host_points_game'),
    path('host-points/<str:room_code>/monitor/', views.host_points_monitor, name='host_points_monitor'),
    path('host-points/<str:room_code>/end/', views.end_host_points_game_by_room_code, name='end_host_points_game_by_room_code'),
    path('wann-war-das/create-custom/', views.create_wann_war_das_game, name='create_wann_war_das_game'),
    path('wann-war-das/update-custom/', views.update_wann_war_das_game, name='update_wann_war_das_game'),
    path('wann-war-das/questions/', views.get_wann_war_das_questions, name='get_wann_war_das_questions'),
    path('wann-war-das/add-question/', views.add_wann_war_das_question, name='add_wann_war_das_question'),
    path('wann-war-das/update-question/', views.update_wann_war_das_question, name='update_wann_war_das_question'),
    path('wann-war-das/question/<int:question_id>/', views.get_wann_war_das_question_detail, name='get_wann_war_das_question_detail'),
    path('wann-war-das/delete-question/', views.delete_wann_war_das_question, name='delete_wann_war_das_question'),
    path('wann-war-das/<int:quiz_id>/selected-questions/', views.get_wann_war_das_selected_questions, name='get_wann_war_das_selected_questions'),
    path('wann-war-das/<str:room_code>/monitor/', views.wann_war_das_monitor, name='wann_war_das_monitor'),
    path('wann-war-das/<str:room_code>/end/', views.end_wann_war_das_game_by_room_code, name='end_wann_war_das_game_by_room_code'),
    ...
    path('quiz/<str:room_code>/promote-answer-correct/', views.promote_quiz_answer_correct, name='promote_quiz_answer_correct'),
    ...
    path('who-that/<str:room_code>/set-question-points/', views.set_who_that_question_points, name='set_who_that_question_points'),
    path('who-that/<str:room_code>/promote-answer-correct/', views.promote_who_that_answer_correct, name='promote_who_that_answer_correct'),
    ...
    path('blackjack/<str:room_code>/select-set/', views.select_blackjack_set, name='select_blackjack_set'),
    path('blackjack/<str:room_code>/scoring-mode/', views.set_blackjack_scoring_mode, name='set_blackjack_scoring_mode'),
